...
public class LocationCityRealmBean extends RealmObject implements CityImpl<LocationCityBean> {
    ...
    @Override
    public LocationCityBean getCityInfo() {
        LocationCityBean cityBean = new LocationCityBean();
        cityBean.setId(id);
